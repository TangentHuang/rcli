...
use std::io::Read;
pub fn process_b64_encode(input: &str, format: Base64Format) -> anyhow::Result<String> {
...
pub fn process_b64_decode(input: &str, format: Base64Format) -> anyhow::Result<String> {
    let mut reader = get_reader(input)?;
